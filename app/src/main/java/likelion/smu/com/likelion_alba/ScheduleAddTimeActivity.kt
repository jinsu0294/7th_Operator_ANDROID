...
import kotlinx.android.synthetic.main.activity_schedule_add.tvDate
import kotlinx.android.synthetic.main.activity_schedule_add_time.*
import org.json.JSONObject

class ScheduleAddTimeActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_schedule_add_time)
